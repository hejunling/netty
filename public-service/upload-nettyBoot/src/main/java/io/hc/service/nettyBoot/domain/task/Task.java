...
public class Task {
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("taskId", taskId).add("reqUrl", reqUrl).add("revUrl", revUrl)
				.add("gmtCreate", gmtCreate).add("gmtHandle", gmtHandle).add("taskHandler", taskHandler)
				.add("taskStatus", taskStatus).add("computeNum", computeNum).add("taskParams", taskParams)
				.add("retryCount", retryCount).add("retryReason", retryReason).add("paramsMap", paramsMap).toString();
	}
}
